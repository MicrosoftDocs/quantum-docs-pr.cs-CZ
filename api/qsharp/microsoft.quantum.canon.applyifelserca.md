...
### <a name="zeroop--t--unit-adj--ctl"></a>zeroOp: t => [jednotka](xref:microsoft.quantum.lang-ref.unit) ADJ + CTL
...
### <a name="oneop--u--unit-adj--ctl"></a>oneOp: ' U => [jednotka](xref:microsoft.quantum.lang-ref.unit) ADJ + CTL
