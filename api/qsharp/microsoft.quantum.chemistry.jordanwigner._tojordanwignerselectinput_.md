...
---
# <a name="_tojordanwignerselectinput_-function"></a>_ToJordanWignerSelectInput_ – funkce
...
## <a name="output--qubitqubitqubitlittleendianlittleendian--unit--is-adj--ctl"></a>Výstup: ([qubit](xref:microsoft.quantum.lang-ref.qubit),[qubit](xref:microsoft.quantum.lang-ref.qubit)[],[qubit](xref:microsoft.quantum.lang-ref.qubit)[],[LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian),[LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian)[]) => [jednotka](xref:microsoft.quantum.lang-ref.unit)  je ADJ + CTL
