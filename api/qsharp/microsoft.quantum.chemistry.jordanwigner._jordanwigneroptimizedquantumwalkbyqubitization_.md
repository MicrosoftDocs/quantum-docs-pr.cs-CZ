...
ms.locfileid: "96215601"
---
# <a name="_jordanwigneroptimizedquantumwalkbyqubitization_-function"></a>_JordanWignerOptimizedQuantumWalkByQubitization_ – funkce
...
## <a name="output--intintdoublequbitqubit--unit--is-adj--ctl"></a>Výstup: (([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)), ([Double](xref:microsoft.quantum.lang-ref.double), ([qubit](xref:microsoft.quantum.lang-ref.qubit)[];[qubit](xref:microsoft.quantum.lang-ref.qubit)[]) => [jednotka](xref:microsoft.quantum.lang-ref.unit)  je ADJ + CTL))
