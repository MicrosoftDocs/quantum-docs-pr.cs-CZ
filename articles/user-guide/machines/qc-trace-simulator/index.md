...
|[Čítač primitivních operací](xref:microsoft.quantum.machines.qc-trace-simulator.primitive-counter)  | Zjišťuje počet primitivních procesů použitých všemi operacemi vyvolanými kvantovým programem.  |
