---
title: Deklarace proměnných a změna přiřazení v Q#
description: Další informace o použití příkazů let a mutable pro svázání proměnných v Q# .
author: bettinaheim
ms.author: beheim
ms.date: 10/07/2020
ms.topic: article
