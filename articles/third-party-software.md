...
ms.locfileid: "98856651"
---
# <a name="third-party-software-notices-and-information"></a>OZNÁMENÍ A INFORMACE O SOFTWARU TŘETÍ STRANY

Tento soubor je založený na nebo zahrnuje materiály z níže uvedených projektů (IP adresa třetí strany). Původní oznámení o autorských právech a licenci, na jejímž základě společnost Microsoft obdržela tyto IP adresy třetích stran, jsou uvedeny níže. Tyto licence a oznámení jsou k dispozici pouze pro informativní účely. Společnost Microsoft uděluje licenci na IP adresu třetích stran na základě licenčních podmínek pro produkt společnosti Microsoft. Společnost Microsoft si vyhrazuje všechna ostatní práva, která nejsou výslovně udělena v rámci této smlouvy, ať už nepřekážkym, nebo jinak.
...
9. xUnit. abstrakce 2.0.1 (https://www.nuget.org/packages/xunit.abstractions/2.0.1)
...
## <a name="yamldotnetsigned-notices-and-information"></a>OZNÁMENÍ a informace o YamlDotNet. Signed
---------------------------------------
...
## <a name="xunitrunnervisualstudio-notices-and-information"></a>xUnit. Runner. VisualStudio – oznámení a informace
---------------------------------------
Copyright (c) .NET Foundation a přispěvatelé všechna práva vyhrazena

Licencovaná v rámci licence Apache verze 2,0 ("licence"); Tento soubor nesmíte použít s výjimkou dodržení licence.
Kopii licence můžete získat na adrese

 [http://www.apache.org/licenses/LICENSE-2.0](http://www.apache.org/licenses/LICENSE-2.0)

Pokud to není vyžadováno platným zákonem nebo odsouhlaseným psaním, software distribuovaný v rámci licence se distribuuje na "tak, jak je", a to bez jakýchkoli záruk nebo podmínek jakéhokoli druhu, ať už výslovně nebo mlčky.
Podívejte se na licenci pro konkrétní jazyk řízení oprávnění a omezení v rámci licence.



## <a name="xunitrunnerconsole-notices-and-information"></a>xUnit. Runner. oznámení a informace konzoly
---------------------------------------
Copyright (c) .NET Foundation a přispěvatelé všechna práva vyhrazena
...
## <a name="xunitextensibilitycore-notices-and-information"></a>xUnit. rozšiřitelnost. základní oznámení a informace
---------------------------------------
Copyright (c) .NET Foundation a přispěvatelé všechna práva vyhrazena
...
## <a name="xunitcore-notices-and-information"></a>OZNÁMENÍ a informace xUnit. Core
---------------------------------------
Copyright (c) .NET Foundation a přispěvatelé všechna práva vyhrazena
...
## <a name="xunitassert-notices-and-information"></a>xUnit. Assert – oznámení a informace
---------------------------------------
Copyright (c) .NET Foundation a přispěvatelé všechna práva vyhrazena
...
## <a name="xunitanalyzers-notices-and-information"></a>OZNÁMENÍ a informace o xUnit. analyzátorech
---------------------------------------
Copyright (c) .NET Foundation a přispěvatelé všechna práva vyhrazena
...
## <a name="xunitabstractions-notices-and-information"></a>OZNÁMENÍ a informace o xUnit. abstrakce
---------------------------------------
Copyright (c) .NET Foundation a přispěvatelé všechna práva vyhrazena
...
## <a name="xunit-notices-and-information"></a>xUnit oznámení a informace
---------------------------------------
Copyright (c) .NET Foundation a přispěvatelé všechna práva vyhrazena
...
## <a name="managedesent-notices-and-information"></a>ManagedEsent oznámení a informace
---------------------------------------
Veřejná licence Microsoftu (MS-PL)

Tato licence řídí použití doprovodného softwaru. Pokud použijete software, přijměte tuto licenci. Pokud licenci nepřijmete, software nepoužívejte.

1. Definice

Termín "reprodukce", "rozmnožování", "odvozená práce" a "distribuce" mají stejný význam jako v souladu s autorským právem USA.

"Příspěvek" je původní software nebo jakékoli dodatky nebo změny softwaru.

"Přispěvatel" je jakákoli osoba, která distribuuje svůj příspěvek v rámci této licence.

"Licencované patenty" jsou patentové deklarace přispěvatele, které se čtou přímo na jeho příspěvku.
...
(A) žádná licence k ochranné známky – Tato licence vám neuděluje práva k používání názvu, loga nebo ochranných známek přispěvatelů.

(B) Pokud přenesete patentovou deklaraci na jakýkoli Přispěvatel nad patenty, které jste vynesli, porušují software vaše patentová licence od tohoto přispěvatele do konce softwaru automaticky.

(C) Pokud distribuujete jakoukoli část softwaru, je nutné uchovávat všechna oznámení o autorských právech, patentech, ochranných známkách a označeních, která se nacházejí v softwaru.
...
## <a name="fsharpcharting-notices-and-information"></a>FSharp. vytváření grafů oznámení a informací
---------------------------------------
Licence MIT (MIT)
...
## <a name="fscheck-notices-and-information"></a>FsCheck oznámení a informace
---------------------------------------
...
## <a name="fparsec-notices-and-information"></a>FParsec oznámení a informace
---------------------------------------
